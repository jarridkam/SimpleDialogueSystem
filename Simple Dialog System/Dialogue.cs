...
{
    [ListDrawerSettings(ShowFoldout = false, DraggableItems = false, ShowIndexLabels = true, ListElementLabelName = "greetingText")]
    public List<Greeting> Greetings = new List<Greeting>();

    [ListDrawerSettings(ShowFoldout = false, DraggableItems = false, ShowIndexLabels = true, ListElementLabelName = "dialogueText")]
    ...
    public string[] GetGreetingText()
    {
        ...
        foreach (var line in Greetings[0].greetingText.responseText)
        {
